    ...
    public class FrontUtils
    {
        ...
        public static long GetCityId(HttpContextBase ctx)
        {
            ...
            if (userId==null)//如果没有用户登录
            {
                ...
                if (cityId!=null)//如果Session中存着CityId，则以此为当前Session的城市Id
                {
                    return cityId.Value;
                }
                else//如果Session中没有CityId,则以第一个城市为CityId
                {
                    //这个类不是AutoFac创建的，手动解析实现类
